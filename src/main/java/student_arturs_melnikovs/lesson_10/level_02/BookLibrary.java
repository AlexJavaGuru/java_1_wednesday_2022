...
import student_arturs_melnikovs.lesson_10.level_02.BookDatabaseImpl;
import student_arturs_melnikovs.lesson_10.level_06.*;
...
class BookLibrary {
    ...
    public BookLibrary() {
        ...
        menuNumberToActionMap.put(13, new GetAuthorToBookMap(bookDatabase));
        menuNumberToActionMap.put(14, new GetEachAuthorBookCount(bookDatabase));
