...
class ContainsUIAction implements UIAction {
    ...
    public void execute() {
        ...
        System.out.println("Please enter the book`s author to check if contains");
        String authorName = scanner.nextLine();
        System.out.println("Please enter the book`s title to check if contains");
        String bookTitle = scanner.nextLine();
        System.out.println("Please enter the book`s year of production to check if contains");
        String bookYearOfProduction = scanner.nextLine();

        Book newBook = new Book(authorName, bookTitle, bookYearOfProduction);
        System.out.println(bookDatabase.contains(newBook));
    }
}